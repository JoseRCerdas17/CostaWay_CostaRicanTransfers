...
export default function HeroSection({ locale }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden">
      ...
      {/* Layer 1: Base opacity - attenuates image across entire section */}
      <div className="absolute inset-0 bg-[#F5F3EF]/75" />

      {/* Layer 2: Gradient - reinforces fade toward header */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#F5F3EF] via-[#F5F3EF]/40 to-transparent" />

      <div className="relative z-10 max-w-container-max mx-auto px-gutter pt-xl pb-lg">
